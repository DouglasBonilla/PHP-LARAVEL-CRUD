...
class DocenteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'DocenteGrupo creado correctamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'DocenteGrupo actualizado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        $docenteGrupo->delete();
        return redirect()->route('docentes_grupos.index')->with('success', 'DocenteGrupo eliminado correctamente');
    }
}
